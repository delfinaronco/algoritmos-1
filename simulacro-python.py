...
def quitar_repetidos (l:list) -> list:
    ...
    for i in l:
        if not(pertenece(sin_repetidos,i)):
            sin_repetidos.append(i)
        
    return sin_repetidos

# print(quitar_repetidos([1,1,2,2,3,3,4,4]))
...
def elementos_exclusivos (s: list, t: list) -> list:
    ...
    quitar_repetidos(diferencia_simetrica)
    
    return diferencia_simetrica

# print(elementos_exclusivos([1,2,3,4],[3,4,5,6]))
...
def convertir_a_diccionario (s: list) -> dict:
